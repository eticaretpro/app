...
return [
    ...
    'admin_plans.plan.campaigns_limit' => 'Site Limiti',
    'admin_plans.plan.notifications_limit' => 'Notifications Limit',
    'admin_plans.plan.track_notifications_retention' => 'Notifications statistics retention',
    'admin_plans.plan.track_notifications_retention_help' => 'How many days will the notifications statistics be kept in the database.',
    'admin_plans.plan.notifications_impressions_limit' => 'Notifications Impressions Limit',
    'admin_plans.plan.notifications_impressions_limit_help' => 'How many times notifications will show on the users website ( in total per month ). Set -1 for unlimited. ( Impression: When one notification shows up on the users website )',
    ...
    'admin_plans.plan.removable_branding' => 'Removable Notifications Branding',
    'admin_plans.plan.removable_branding_help' => 'This gives the option for people to remove branding from notifications.',
    'admin_plans.plan.custom_branding' => 'Custom Notifications Branding',
    'admin_plans.plan.custom_branding_help' => 'This gives the option for people to add their custom branding for notifications.',
    'admin_plans.plan.enabled_notifications' => 'Enabled Notifications',
    'admin_plans.plan.enabled_notifications_help' => 'Select which notifications are enabled for usage on this plan.',
    ...
    'admin_index.track_notifications' => 'Notifications shown',
    'admin_index.track_logs' => 'Pixel script loads',
    'admin_index.track_conversions' => 'Tracked conversions',
    ...
    'admin_users.main.name' => 'Ad Soyad',
    ...
    'admin_user_view.campaigns' => 'Siteler',
    'admin_user_view.notifications' => 'Notifications',
    ...
    'admin_settings.documentation' => 'Read the <a href="https://altumco.de/66socialproof-docs" target="_blank">Documentation</a> to get more details on certain available configurations.',
    ...
    'admin_settings.notifications.tab' => 'Notifications',
    'admin_settings.notifications.branding' => 'Branding',
    'admin_settings.notifications.branding_help' => 'This branding is used by default in the notification. HTML can be used in this field.',
    'admin_settings.notifications.analytics_is_enabled' => 'Analytics for notifications',
    'admin_settings.notifications.analytics_is_enabled_help' => 'This option allows you to enable or disable the Analytics that are generated for notifications.',
    'admin_settings.notifications.pixel_cache' => 'Pixel Cache (in seconds)',
    'admin_settings.notifications.pixel_cache_help' => 'Set 0 to disable the cache of the pixel tracking code.',
    ...
    'admin_statistics.payments.no_payments' => 'There are no recorded payments for this date range.',
    ...
    'admin_statistics.growth.users.chart' => 'Üyeler',
    ...
    'admin_statistics.campaigns.menu' => 'Siteler',
    'admin_statistics.campaigns.header' => 'Siteler',
    'admin_statistics.campaigns.chart' => 'Yeni Site',

    'admin_statistics.notifications.menu' => 'Notifications',
    'admin_statistics.notifications.header' => 'Notifications',
    'admin_statistics.notifications.chart' => 'New notifications',

    'admin_statistics.track_notifications.menu' => 'Notifications analytics',
    'admin_statistics.track_notifications.header' => 'Notifications analytics',
    'admin_statistics.track_notifications.subheader' => 'Collected analytics for notifications which are running on your users websites.',
    'admin_statistics.track_notifications.chart_impression' => 'Impressions',
    'admin_statistics.track_notifications.chart_hover' => 'Hovers',
    'admin_statistics.track_notifications.chart_click' => 'Clicks',
    'admin_statistics.track_notifications.chart_form_submission' => 'Form Submissions',

    'admin_statistics.track_conversions.menu' => 'Notifications conversions',
    'admin_statistics.track_conversions.header' => 'Notifications conversions',
    'admin_statistics.track_conversions.subheader' => 'The amount of conversions that are caught by the system for all the created notifications.',
    'admin_statistics.track_conversions.chart_webhook' => 'Webhooks',
    'admin_statistics.track_conversions.chart_auto_capture' => 'Auto captured',
    'admin_statistics.track_conversions.chart_collector' => 'Collector notifications',
    'admin_statistics.track_conversions.chart_imported' => 'Imported',
    ...
    'admin_campaigns.title' => 'Siteler',
    'admin_campaigns.header' => 'Siteler',
    'admin_campaigns.menu' => 'Siteler',

    'admin_campaigns.table.user' => 'User',
    'admin_campaigns.table.campaign' => 'Site',
    'admin_campaigns.table.status' => 'Status',

    'admin_campaigns.filters.name' => 'Name',
    'admin_campaigns.filters.domain' => 'Domain',


    'admin_notifications.title' => 'Notifications',
    'admin_notifications.header' => 'Notifications',
    'admin_notifications.menu' => 'Notifications',

    'admin_notifications.table.user' => 'User',
    'admin_notifications.table.notification' => 'Araçlar',
    'admin_notifications.table.status' => 'Status',

    'admin_notifications.filters.type' => 'Notification type',
    'admin_notifications.filters.name' => 'Name',
];
