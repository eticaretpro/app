...
class User extends Model {
    ...
    public function delete($user_id) {
        ...
        if(settings()->webhooks->user_delete) {
            ...
            $user = db()->where('user_id', $user_id)->getOne('users', ['user_id', 'email', 'name', 'phone']);
    ...
    public function create(
        ...
        $billing = json_encode(['type' => 'personal', 'name' => '', 'phone' => '', 'address' => '', 'city' => '', 'county' => '', 'zip' => '', 'country' => '', 'phone' => '', 'tax_id' => '',]);
