...
class Notification extends Controller {
        ...
        if(!empty($_POST)) {
            ...
            switch($this->notification->type) {
                ...
                case 'COUPON':
                    ...
                    $_POST['url_new_tab'] = (bool) isset($_POST['url_new_tab']);
                    $_POST['button_text'] = mb_substr(query_clean($_POST['button_text']), 0, 2048);
                ...
                case 'CUSTOM_HTML':
                    ...
                    $_POST['css'] = mb_substr($_POST['css'], 0, 8192);
                    $_POST['js'] = mb_substr($_POST['js'], 0, 8192);
                    $_POST['border_radius'] = in_array($_POST['border_radius'], [
                        'straight',
                        'rounded',
                        'round',
                    ...
                    /* Clean some posted variables */
                    $_POST['html'] = mb_substr($_POST['html'], 0, 8192);
                    $_POST['css'] = mb_substr($_POST['html'], 0, 8192);
                    $_POST['script'] = mb_substr($_POST['html'], 0, 8192);
                    $_POST['border_radius'] = in_array($_POST['border_radius'], [
                        'straight',
                        'rounded',
                        'round',
    ...
    public function delete() {
        ...
        if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
            ...
            /* Clear the cache */
            \Altum\Cache::$adapter->deleteItem('campaigns_total?user_id=' . $this->user->user_id);
