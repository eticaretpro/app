...
class Campaign extends Controller {
    ...
    public function index() {
        ...
        $method = isset($this->params[1]) && in_array($this->params[1], ['settings', 'statistics', 'support']) ? $this->params[1] : 'settings';
        ...
        switch($method) {
            case 'settings':
                ...
                $filters = (new \Altum\Filters(['is_enabled', 'type'], ['name'], ['last_datetime', 'name', 'datetime']));
                ...
                if($action) {
                    switch($action) {
                        case 'reset':
                            ...
                            redirect('campaign/' . $campaign->campaign_id . '/support');
