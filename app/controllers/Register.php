...
class Register extends Controller {
    ...
    public function index() {
        ...
        $values = [
            ...
            'phone' => isset($_GET['phone']) ? query_clean($_GET['phone']) : '',
        ...
        if(!empty($_POST)) {
            ...
            $_POST['phone'] = mb_substr(trim(input_clean($_POST['phone'])), 0, 64);
            ...
            if(mb_strlen($_POST['phone']) < 1 || mb_strlen($_POST['phone']) > 64) {
                Alerts::add_field_error('phone', l('register.error_message.phone_length'));
            }
