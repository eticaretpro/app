    ...
    <?php if(settings()->payment->is_enabled): ?>
        ...
        >
            <div class="pricing-deco" style="<?= $plan->color ? 'background-color: ' . $plan->color : null ?>">
                ...
                <div class="pricing-price">
                    <span class="d-none" data-plan-payment-frequency="monthly"><?= nr($plan->monthly_price, 2, false) ?></span>
                    <span class="d-none" data-plan-payment-frequency="annual"><?= nr($plan->annual_price, 2, false) ?></span>
                    <span class="d-none" data-plan-payment-frequency="lifetime"><?= nr($plan->lifetime_price, 2, false) ?></span>
