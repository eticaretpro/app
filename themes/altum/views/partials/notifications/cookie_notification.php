    ...
    <div class="altumcode-cookie-notification-content">
        ...
        <div class="altumcode-cookie-notification-header">
            <?php if(!empty($notification->settings->image)): ?>
                <img src="<?= (substr($notification->settings->image, 0, 4) === 'http') ? $notification->settings->image : \Altum\Uploads::get_full_url('notifications') . $notification->settings->image ?>" class="altumcode-cookie-notification-image" loading="lazy" />
            <?php endif ?>
        ...
        <button type="button" class="altumcode-cookie-notification-button" onclick="<?= $notification->settings->image_alt ?>" style="background: <?= $notification->settings->button_background_color ?>;color: <?= $notification->settings->button_color ?>"><?= $notification->settings->button_text ?></button>
