        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->values['url'] ?>" placeholder="<?= l('admin_resources.main.url_placeholder') ?>" required="required" />
            ...
            <div class="form-group">
                ...
                <input id="icon" type="text" name="icon" class="form-control" value="<?= $data->values['icon'] ?>" placeholder="<?= l('admin_pages_categories.input.icon_placeholder') ?>" />
