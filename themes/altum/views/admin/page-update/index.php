...
<div class="d-flex justify-content-between mb-4">
    ...
    <?= include_view(THEME_PATH . 'views/admin/pages/admin_page_dropdown_button.php', ['id' => $data->page->page_id, 'resource_name' => $data->page->title, 'url' => $data->page->url, 'language' => $data->page->language, 'type' => $data->page->type]) ?>
</div>
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group" data-type="internal">
                ...
                <div class="input-group">
                    ...
                    <input id="url" type="text" name="url" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" placeholder="<?= l('admin_resources.main.url_internal_placeholder') ?>" value="<?= $data->page->url ?>" required="required" />
            ...
            <div class="form-group" data-type="external">
                <label for="url"><i class="fa fa-fw fa-sm fa-bolt text-muted mr-1"></i> <?= l('admin_resources.main.url') ?></label>
                <input id="url" type="url" name="url" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" value="<?= $data->page->url ?>" placeholder="<?= l('admin_resources.main.url_external_placeholder') ?>" required="required" />
                <?= \Altum\Alerts::output_field_error('url') ?>
            </div>
            ...
            <div class="form-group">
                ...
                <input id="title" type="text" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->page->title ?>" required="required" />
            ...
            <div class="form-group" data-type="internal">
                ...
                <input id="description" type="text" name="description" class="form-control" value="<?= $data->page->description ?>" />
            </div>

            <div class="form-group" data-type="internal">
                <label for="keywords"><i class="fa fa-fw fa-sm fa-file-word text-muted mr-1"></i> <?= l('admin_resources.main.keywords') ?></label>
                <input id="keywords" type="text" name="keywords" class="form-control" value="<?= $data->page->keywords ?>" />
            ...
            <div class="form-group" data-type="internal">
                ...
                <textarea name="content" id="content" class="form-control d-none" style="height: 15rem;"><?= $data->page->content ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="pages_category_id" name="pages_category_id" class="form-control">
            ...
            <div class="form-group custom-control custom-switch">
                <input id="is_published" name="is_published" type="checkbox" class="custom-control-input" <?= $data->page->is_published ? 'checked="checked"' : null ?>>
