    ...
    <div class="mb-3 mb-xl-5 mb-xl-0 col-12 col-xl-4">
        <div class="d-xl-none">
            <select name="settings_menu" class="form-control">
                ...
                <option value="<?= url('admin/settings/notifications') ?>" class="nav-link" <?= $data->method == 'notifications' ? 'selected="selected"' : null ?>><?= l('admin_settings.notifications.tab') ?></option>
        ...
        <div class="card d-none d-xl-flex">
            <div class="card-body">
                <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= $data->method == 'notifications' ? 'active' : null ?>" href="<?= url('admin/settings/notifications') ?>"><i class="fa fa-fw fa-sm fa-bell mr-1"></i> <?= l('admin_settings.notifications.tab') ?></a>
