        ...
        <div class="card h-100">
            <div class="card-body">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label for="email" class="font-weight-bold"><i class="fa fa-fw fa-sm fa-phone text-muted mr-1"></i> <?= l('admin_users.main.phone') ?></label>
                    <input id="phone" type="text" class="form-control-plaintext" value="<?= $data->user->phone ?>" readonly />
                </div>
...
<div class="my-5 row justify-content-between">
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-server mr-1"></i> <?= l('admin_user_view.campaigns') ?></small>
    ...
    <div class="col-12 col-sm-6 col-xl-3 mb-4 position-relative">
        <div class="card d-flex flex-row h-100 overflow-hidden">
            <div class="card-body">
                <small class="text-muted"><i class="fa fa-fw fa-sm fa-bell mr-1"></i> <?= l('admin_user_view.notifications') ?></small>
