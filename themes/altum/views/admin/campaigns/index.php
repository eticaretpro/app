...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    <h1 class="h3 mb-3 mb-md-0"><i class="fa fa-fw fa-xs fa-server text-primary-900 mr-2"></i> <?= l('admin_campaigns.header') ?></h1>
                ...
                <div class="dropdown-menu dropdown-menu-right filters-dropdown">
                    <div class="dropdown-header d-flex justify-content-between">
                        ...
                        <?php if(count($data->filters->get)): ?>
                            <a href="<?= url('admin/campaigns') ?>" class="text-muted"><?= l('global.filters.reset') ?></a>
                        <?php endif ?>
                    </div>
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="search_by" id="filters_search_by" class="form-control form-control-sm">
                                <option value="name" <?= $data->filters->search_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_campaigns.filters.name') ?></option>
                                <option value="domain" <?= $data->filters->search_by == 'domain' ? 'selected="selected"' : null ?>><?= l('admin_campaigns.filters.domain') ?></option>
                            </select>
                        </div>
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="form-control form-control-sm">
                                ...
                                <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('admin_campaigns.filters.name') ?></option>
                                <option value="domain" <?= $data->filters->order_by == 'domain' ? 'selected="selected"' : null ?>><?= l('admin_campaigns.filters.domain') ?></option>
                            </select>
                        </div>
...
<div class="table-responsive table-custom-container">
    <table class="table table-custom">
        ...
        <tr>
            ...
            <th><?= l('admin_campaigns.table.user') ?></th>
            <th><?= l('admin_campaigns.table.campaign') ?></th>
            <th><?= l('admin_campaigns.table.status') ?></th>
            <th></th>
            <th></th>
            <th></th>
        </tr>
            ...
            <tr>
                ...
                <td class="text-nowrap">
                    <div class="d-flex align-items-center">
                        <a href="<?= url('admin/notifications?campaign_id=' . $row->campaign_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_notifications.menu') ?>">
                            <i class="fa fa-fw fa-bell text-muted"></i>
                        </a>
                    </div>
                </td>
