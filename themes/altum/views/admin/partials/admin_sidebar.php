...
<section class="admin-sidebar">
    ...
    <ul class="admin-sidebar-links">
        ...
        <li class="<?= \Altum\Router::$controller == 'AdminCampaigns' ? 'active' : null ?>">
            <a class="nav-link text-truncate" href="<?= url('admin/campaigns') ?>">
                <i class="fa fa-fw fa-sm fa-server mr-2"></i> <?= l('admin_campaigns.menu') ?>
            </a>
        </li>

        <li class="<?= \Altum\Router::$controller == 'AdminNotifications' ? 'active' : null ?>">
            <a class="nav-link text-truncate" href="<?= url('admin/notifications') ?>">
                <i class="fa fa-fw fa-sm fa-bell mr-2"></i> <?= l('admin_notifications.menu') ?>
            </a>
        </li>
