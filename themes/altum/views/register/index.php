...
<div class="form-group">
        <label for="email"><?= l('register.form.phone') ?></label>
        <input id="email" type="number" name="phone" class="form-control <?= \Altum\Alerts::has_field_errors('phone') ? 'is-invalid' : null ?>" value="<?= $data->values['phone'] ?>" maxlength="11" required="required" />
