        ...
        <?php foreach($data->notification->settings->triggers as $trigger): ?>
            <div class="form-group">
                <div class="input-group">
                    ...
                    <button type="button" class="trigger-delete ml-3 btn btn-outline-danger btn-sm" aria-label="<?= l('global.delete') ?>"><i class="fas fa-fw fa-times"></i></button>
                </div>
            </div>
        <?php endforeach ?>
    <?php endif ?>
...
<div class="mb-3">
    <button type="button" id="trigger_add" class="btn btn-outline-success btn-sm"><i class="fas fa-fw fa-plus-circle fa-sm mr-1"></i> <?= l('notification.settings.trigger_add') ?></button>
</div>
...
<div class="form-group">
    ...
    <small class="form-text text-muted"><?= l('notification.settings.display_trigger_value_help') ?></small>
</div>
...
<div class="form-group custom-control custom-switch">
    ...
    <label class="custom-control-label clickable" for="display_mobile"><i class="fas fa-fw fa-sm fa-mobile text-muted mr-1"></i> <?= l('notification.settings.display_mobile') ?></label>
...
<div class="form-group custom-control custom-switch">
    ...
    <label class="custom-control-label clickable" for="display_desktop"><i class="fas fa-fw fa-sm fa-desktop text-muted mr-1"></i> <?= l('notification.settings.display_desktop') ?></label>
...
<div class="form-group">
    <label for="settings_font"><svg class="svg-inline--fa fa-pen-nib fa-fw fa-sm text-muted mr-1" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pen-nib" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M368.4 18.3L312.7 74.1 437.9 199.3l55.7-55.7c21.9-21.9 21.9-57.3 0-79.2L447.6 18.3c-21.9-21.9-57.3-21.9-79.2 0zM288 94.6l-9.2 2.8L134.7 140.6c-19.9 6-35.7 21.2-42.3 41L3.8 445.8c-3.8 11.3-1 23.9 7.3 32.4L164.7 324.7c-3-6.3-4.7-13.3-4.7-20.7c0-26.5 21.5-48 48-48s48 21.5 48 48s-21.5 48-48 48c-7.4 0-14.4-1.7-20.7-4.7L33.7 500.9c8.6 8.3 21.1 11.2 32.4 7.3l264.3-88.6c19.7-6.6 35-22.4 41-42.3l43.2-144.1 2.8-9.2L288 94.6z"></path></svg><!-- <i class="fas fa-fw fa-pen-nib fa-sm text-muted mr-1"></i> Font Awesome fontawesome.com --> <?= l('notification.settings.font') ?></label>
    <div class="row btn-group-toggle" data-toggle="buttons">
                <div class="col-6 col-lg-4 h-100">
                    <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'inherit' ? 'active' : null ?>">
                    <input type="radio" name="font" value="inherit" class="custom-control-input" <?= $data->notification->settings->font == 'inherit' ? 'checked="checked"' : null ?> required="required">
                       Site Fontu       </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Arial' ? 'active' : null ?>" style="font-family: Arial !important;">
                    <input type="radio" name="font" value="Arial" class="custom-control-input" <?= $data->notification->settings->font == 'Arial' ? 'checked="checked"' : null ?> required="required">
                    Arial                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Verdana' ? 'active' : null ?>" style="font-family: Verdana !important;">
                    <input type="radio" name="font" value="Verdana" class="custom-control-input" <?= $data->notification->settings->font == 'Verdana' ? 'checked="checked"' : null ?> required="required">
                    Verdana                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Helvetica' ? 'active' : null ?>" style="font-family: Helvetica !important;">
                    <input type="radio" name="font" value="Helvetica" class="custom-control-input" <?= $data->notification->settings->font == 'Helvetica' ? 'checked="checked"' : null ?> required="required">
                    Helvetica                </label>
                </div>
                
                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Tahoma' ? 'active' : null ?>" style="font-family: Tahoma !important;">
                    <input type="radio" name="font" value="Tahoma" class="custom-control-input" <?= $data->notification->settings->font == 'Tahoma' ? 'checked="checked"' : null ?> required="required">
                    Tahoma                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Trebuchet MS' ? 'active' : null ?>" style="font-family: Trebuchet MS !important;">
                    <input type="radio" name="font" value="Trebuchet MS" class="custom-control-input" <?= $data->notification->settings->font == 'Trebuchet MS' ? 'checked="checked"' : null ?> required="required">
                    Trebuchet MS                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Times New Roman' ? 'active' : null ?>" style="font-family: Times New Roman !important;">
                    <input type="radio" name="font" value="Times New Roman" class="custom-control-input" <?= $data->notification->settings->font == 'Times New Roman' ? 'checked="checked"' : null ?> required="required">
                    Times New Roman                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Georgia' ? 'active' : null ?>" style="font-family: Georgia !important;">
                    <input type="radio" name="font" value="Georgia" class="custom-control-input" <?= $data->notification->settings->font == 'Georgia' ? 'checked="checked"' : null ?> required="required">
                    Georgia                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Garamond' ? 'active' : null ?>" style="font-family: Garamond !important;">
                    <input type="radio" name="font" value="Garamond" class="custom-control-input" <?= $data->notification->settings->font == 'Garamond' ? 'checked="checked"' : null ?> required="required">
                    Garamond                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Courier New' ? 'active' : null ?>" style="font-family: Courier New !important;">
                    <input type="radio" name="font" value="Courier New" class="custom-control-input" <?= $data->notification->settings->font == 'Courier New' ? 'checked="checked"' : null ?> required="required">
                    Courier New                </label>
                </div>

                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Monaco' ? 'active' : null ?>" style="font-family: Monaco !important;">
                    <input type="radio" name="font" value="Monaco" class="custom-control-input" <?= $data->notification->settings->font == 'Monaco' ? 'checked="checked"' : null ?> required="required">
                    Monaco                </label>
                </div>

                  <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Comic Sans MS' ? 'active' : null ?>" style="font-family: Comic Sans MS !important;">
                    <input type="radio" name="font" value="Comic Sans MS" class="custom-control-input" <?= $data->notification->settings->font == 'Comic Sans MS' ? 'checked="checked"' : null ?> required="required">
                    Comic Sans MS                </label>
                </div>


                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Courier' ? 'active' : null ?>" style="font-family: Courier !important;">
                    <input type="radio" name="font" value="Courier" class="custom-control-input" <?= $data->notification->settings->font == 'Courier' ? 'checked="checked"' : null ?> required="required">
                    Courier                </label>
                </div>


                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Lucida Console' ? 'active' : null ?>" style="font-family: Lucida Console !important;">
                    <input type="radio" name="font" value="Lucida Console" class="custom-control-input" <?= $data->notification->settings->font == 'Lucida Console' ? 'checked="checked"' : null ?> required="required">
                    Lucida Console               </label>
                </div>


                <div class="col-6 col-lg-4 h-100">
                <label class="btn btn-gray-200 btn-block text-truncate <?= $data->notification->settings->font == 'Impact' ? 'active' : null ?>" style="font-family: Impact !important;">
                    <input type="radio" name="font" value="Impact" class="custom-control-input" <?= $data->notification->settings->font == 'Impact' ? 'checked="checked"' : null ?> required="required">
                    Impact              </label>
                </div>
...
<div class="mt-5 mb-3 row">
    <div class="col-12 mb-5 col-md-7 mb-md-0">
        <ul class="nav nav-pills flex-column nav-custom2 flex-lg-row justify-content-between mb-4" id="pills-tab" role="tablist">
            ...
            <?php if(in_array('triggers', $data->notification->settings->enabled_settings_tabs)): ?>
                <li class="nav-item">
                    <a class="nav-link" id="tab_triggers_link" data-toggle="pill" href="#tab_triggers" role="tab" aria-controls="tab_triggers" aria-selected="false">
                        <i class="fas fa-fw fa-sm fa-angle-up mr-1"></i> <?= l('notification.settings.tab_triggers') ?>
                    </a>
                </li>
            <?php endif ?>
            ...
            <?php if(in_array('display', $data->notification->settings->enabled_settings_tabs)): ?>
                <li class="nav-item">
                    <a class="nav-link" id="tab_display_link" data-toggle="pill" href="#tab_display" role="tab" aria-controls="tab_display" aria-selected="false">
                        <i class="fas fa-fw fa-sm fa-sliders-h mr-1"></i> <?= l('notification.settings.tab_display') ?>
                    </a>
                </li>
            <?php endif ?>
...
<div style="display:none" id="data_trigger_auto_rule_sample">
    <div class="form-group">
        <div class="input-group">
            ...
            <button type="button" class="data-trigger-auto-delete ml-3 btn btn-outline-danger btn-sm" aria-label="<?= l('global.delete') ?>"><i class="fas fa-fw fa-times"></i></button>
        </div>
    </div>
</div>
