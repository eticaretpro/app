...
<script>
    ...
    $('#altumcode-collector-two-modal-form').on('submit', event => event.preventDefault());

    /* Notification Preview Handlers */
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-collector-two-modal-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .altumcode-collector-two-modal-description').text($(event.currentTarget).val());
    });
    ...
    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-collector-two-modal-image-holder').css('background-image', `url('${$(event.currentTarget).val()}')`);
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .altumcode-collector-two-modal-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_description_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .altumcode-collector-two-modal-description').css('color', hsva.toHEXA().toString());
    });
