...
<?php ob_start() ?>
    ...
    <div class="form-group">
        ...
        <textarea  name="html" class="form-control" maxlength="8192" required="required"><?= $data->notification->settings->html ?></textarea>
        <small class="form-text text-muted"><?= l('notification.settings.html_help') ?></small>
    </div>

    <div class="row btn-group-toggle" data-toggle="buttons">
         <div class="form-group col-6">
        <label for="settings_css"><?= l('notification.settings.css') ?></label>
        <textarea  name="css" class="form-control" maxlength="8192"><?= $data->notification->settings->css ?></textarea>
    </div>

     <div class="form-group col-6">
        <label for="settings_js"><?= l('notification.settings.js') ?></label>
        <textarea  name="js" class="form-control" maxlength="8192"><?= $data->notification->settings->js ?></textarea>
    </div>
    </div>
...
<div class="form-group" style="display:none;">
    ...
    <div class="custom-control custom-switch mr-3 mb-3" style="display:none;">
        <input
            type="checkbox"
            class="custom-control-input"
            id="settings_shadow"
