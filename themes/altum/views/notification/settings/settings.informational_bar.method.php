...
<script>
    ...
    $('#settings_title').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-bar-title').text($(event.currentTarget).val());
    });

    $('#settings_description').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-bar-description').text($(event.currentTarget).val());
    });

    $('#settings_image').on('change paste keyup', event => {
        $('#notification_preview .altumcode-informational-bar-image').attr('src', $(event.currentTarget).val());
    });
    ...
    settings_title_color_pickr.on('change', hsva => {
        ...
        $('#notification_preview .altumcode-informational-bar-title').css('color', hsva.toHEXA().toString());
    });
    ...
    settings_description_color_pickr.on('change', hsva => {
        ...
        /* Notification Preview Handler */
        $('#notification_preview .altumcode-informational-bar-description').css('color', hsva.toHEXA().toString());
    });
