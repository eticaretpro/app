...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_html"><?= l('notification.settings.css') ?></label>
        <textarea id="settings_html" name="html" class="form-control" maxlength="8192" required="required" style="height: 300px;"><?= $data->notification->settings->html ?></textarea>
    </div>
