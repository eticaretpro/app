...
<div class="form-group">
    <label for="settings_content_title"><?= l('notification.settings.content_title') ?></label>
...
<div class="form-group">
    <label for="settings_content_description"><?= l('notification.settings.content_description') ?></label>
...
<div class="form-group">
    <label for="settings_content_title_color"><?= l('notification.settings.content_title_color') ?></label>
    <input type="hidden" id="settings_content_title_color" name="content_title_color" class="form-control" value="<?= $data->notification->settings->content_title_color ?>" />
    <div id="settings_content_title_color_pickr"></div>
</div>

<div class="form-group">
    <label for="settings_content_description_color"><?= l('notification.settings.content_description_color') ?></label>
    <input type="hidden" id="settings_content_description_color" name="content_description_color" class="form-control" value="<?= $data->notification->settings->content_description_color ?>" />
