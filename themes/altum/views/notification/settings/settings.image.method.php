...
<div class="form-group">
    <label for="settings_image_alt">Resim Genişliği (Px)</label>
    <input type="number" id="settings_image_alt" name="image_alt" class="form-control" placeholder="Örnek: 400" value="<?= $data->notification->settings->image_alt ?>" maxlength="100" />
    <small class="form-text text-muted">Pixel olarak yazabilirsiniz. (Sadece sayı giriniz)</small>
</div>
