...
<?php ob_start() ?>
    ...
    <div class="form-group">
        <label for="settings_footer_text"><?= l('notification.settings.footer_text') ?></label>
        <input type="text" id="settings_footer_text" name="footer_text" class="form-control" value="<?= $data->notification->settings->footer_text ?>" maxlength="256" />
    </div>
