    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li>
                    <a href="<?= url('campaign/' . $data->notification->campaign_id) ?>"><?= $data->campaign->domain ?></a><i class="fa fa-fw fa-angle-right"></i>
                </li>
        ...
        <div class="row">
            <div class="col text-truncate">
                <h1 class="h2 text-truncate"><?= $data->notification->name ?></h1>
